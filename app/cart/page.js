    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-800 mb-4">आपका कार्ट खाली है</h2>
          <p className="text-gray-600 mb-8">अभी खरीदारी शुरू करें और अपनी पसंदीदा किताबें जोड़ें</p>
          <Link 
            href="/books"
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <button
              onClick={() => {
                if (confirm('क्या आप पूरा कार्ट खाली करना चाहते हैं?')) {
                  clearCart();
                }
              }}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
              ...
              <button
                ...
                className="w-full bg-teal-600 hover:bg-teal-700 text-white px-6 py-4 rounded-lg font-semibold text-lg transition-colors mb-4"
              >
                चेकआउट करें
              </button>
